...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        count_entrance = 0
        while len(now_place.bees) == 0 and now_place != beehive or count_entrance < self.min_range:
        	now_place = now_place.entrance
        	count_entrance += 1
        	if now_place == None:
        		return None
        if now_place == beehive:
        	return None
        if count_entrance > self.max_range:
        	return None
